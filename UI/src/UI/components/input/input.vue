<template>
    <div :class="wrapClasses">
        <template v-if="type !== 'textarea'">
            ...
            <i class="ivu-icon ivu-icon-ios-search" :class="[prefixCls + '-icon', prefixCls + '-icon-normal', prefixCls + '-search-bar-icon']" v-else-if="search && enterButton === false" @click="handleSearch"></i>
            ...
            <div :class="[prefixCls + '-group-append', prefixCls + '-search-bar']" v-else-if="search && enterButton" @click="handleSearch">
    ...
    export default {
        ...
        methods: {
            handleEnter (event) {
                ...
                if (this.search) this.$emit('on-search-bar', this.currentValue);
            },
            handleKeydown (event) {
            ...
            handleSearch () {
                ...
                this.$refs.input.focus();
                this.$emit('on-search-bar', this.currentValue);
            },
